...
export default function Home() {
  return (
    <div className="bg-gradient-to-b from-zinc-50 to-white">
      ...
      {/* CTA Section */}
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="rounded-2xl bg-zinc-900 px-6 py-16 text-center sm:px-12">
          ...
          <div className="mt-8">
            <Link
              href="/login"
              className="rounded-full bg-white px-8 py-3 text-base font-medium text-zinc-900 transition-colors hover:bg-zinc-100"
            >
              Sign Up Now
            </Link>
          </div>
